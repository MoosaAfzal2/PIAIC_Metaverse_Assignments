...
let deadline = addZero(input.year) + "-" + addZero(input.month) + "-" + addZero(input.day) + "T" + input.Time + ":" + "00";
let Timer = () => {
    ...
    process.stdout.write(chalk.whiteBright(`${addZero(days)}          ${addZero(hours)}           ${addZero(minutes)}            ${addZero(seconds)}`));
    return total;
};
