...
let input = await inquirer.prompt([
    ...
    { type: "input", name: "mobileNumber", message: chalk.greenBright("Enter Mobile Number (With 0 instead of +92): "), validate: (input) => { if (input.length < 11) {
            return "Please Enter a Valid Mobile Number";
        } return true; } },
]);
let customer = new Customer(input.firstname, input.lastname, input.gender, input.age, input.mobileNumber);
